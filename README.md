...
- [Usage](docs/usage.md): operating instructions, an example Pine indicator, and replay
  data support
- [Architecture](docs/architecture.md): project structure and data flow
- [Pine compatibility](docs/pine-compatibility.md): supported language subset, execution
  model, resource limits, and known incompatibilities
- [iPhone and iPad release plan](docs/ios-ipados-release-plan.md)

## Tests

Run the `DegenViewTests` unit test suite with:
